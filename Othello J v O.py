...
def play_othello_JvO():
    ...
    c=60 #Taille en pixels de chaque case de la grise
...
def create_frame_bottom():
    ...
    frame_bottom_dif=tk.Frame(fen1,height=90,width=width/2-5,bg='green',bd=2,
        relief=tk.SOLID)
    ...
    frame_bottom_pass=tk.Frame(fen1,height=90,width=width/2-5,bg='green',bd=2,
        relief=tk.SOLID)
    ...
    but_dif_0=tk.Button(frame_bottom_dif,text='Facile',font='Times 15',
        command=dif0)
    but_dif_0.grid(column=0,row=1,padx=3)
    ...
    but_dif_2=tk.Button(frame_bottom_dif,text='Difficile',font='Times 15',
        command=dif2)
    but_dif_2.grid(column=2,row=1,padx=3)
